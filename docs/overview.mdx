...
<CardGroup cols={2}>
  ...
  <Card title="Tool Injector Plugin" icon="screwdriver-wrench" href="/features/plugins/tool-injector">
    Inject provider-native or function tools at the gateway layer before upstream execution.
  </Card>
</CardGroup>
